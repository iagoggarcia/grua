...
CPP_SOURCES = $(SRC_DIR)/main.cpp $(SRC_DIR)/cubo.cpp $(SRC_DIR)/grua.cpp $(SRC_DIR)/esfera.cpp $(SRC_DIR)/camaras.cpp $(SRC_DIR)/tiempo.cpp $(SRC_DIR)/texturas.cpp $(SRC_DIR)/luces.cpp
